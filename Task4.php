  ...
  <body>
    <div class="main-block">
      ...
      <form action="page.php" method="post" enctype="multipart/form-data" >
        ...
        <label id="icon" for="name"><i class="fa-brands fa-linkedin-in"></i></label>
        <input type="text" name="linkedin" id="name" placeholder="linkdIn" required/>
        <label id="icon" for="name"><i class="fas fa-address-book"></i></label>
        <input type="text" name="address" id="name" placeholder="address" required/><br>
        <label for="exampleInputName"><h3><b>Cv</b></h3></label>
